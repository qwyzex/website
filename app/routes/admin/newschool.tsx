...
const NewSchool = () => {
	...
	const [formYearInValue, setFormYearInValue] = useState('');
	const [formYearOutValue, setFormYearOutValue] = useState('');
	...
	async function handleSubmit() {
		await addDoc(schoolsRef, {
			...
			yearIn: formYearInValue.toString(),
			yearOut:
				formYearOutValue === null
					? 'Current'
					: formYearOutValue.toString(),
		});

...
// form
const ContactForm = () => {
	const [state, handleSubmit]: any = useForm('mpzbwqyk');
	...
	return (
		<div className='contact-info'>
			<article>
				<h2>INFORMATION</h2>
				<p>
					Manually contact me here! Actually, I don't really active on
					social media. But you can try!
				</p>
			</article>

		...
		<div className='about-container'>
			...
			<article>
				...
				<p>
					...
					<ColorText ex='remix'>Remix</ColorText>, a{' '}
				...
				<p>
					...
					horribly, and may impact the UX. After actually make a{' '}
					<ColorText ex='nodejs'>NodeJS</ColorText> App with{' '}
					<code>
			...
			<div className='assets'>
					...
					{assets.map((at) => (
						<div className='assets-wrapper' key={at.name}>
							...
							<div className='assets-data' key={at.name}>
								<p key={at.width}>
									Width :{' '}
									<span key={at.width}>{at.width}</span>
								</p>
								<p key={at.height}>
									Height :{' '}
									<span key={at.height}>{at.height}</span>
								</p>
								<p key={at.size}>
									File Size :{' '}
									<span key={at.size}>{at.size}</span>
								</p>
				...
				<section className='license'>
					...
					<hr />
					<p>
						You can use this Images for personal use, altough I
						don't know why... But not for commercial use. You can
						use it for a thumbnail, maybe. I don't actually know
						what I'm sayin' smh.
					</p>
